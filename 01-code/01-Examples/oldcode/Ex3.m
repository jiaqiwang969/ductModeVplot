...
for i_file = Num_file
    ...
    [temp,freq]=cpsd(TT1,TT2,Wind,Noverlap,Nfft,Fs);
    CC1{i_file}=temp;
...
%
N=500;
Freq_slice = linspace(0.01,2.2,N);    %对应1xBPF
df =freq(2) - freq(1);
...
figure
imagesc(Mode1,Freq_slice,temp_sym)
axis xy
...
figure
imagesc(Mode1,Freq_slice,(temp_sym./mean(temp_sym,2)/(2*10^-5)),[30000 7*10^5])
axis xy
xlabel('Mode:m')
ylabel('阶次')
colorbar
