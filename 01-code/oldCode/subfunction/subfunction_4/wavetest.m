...
load testdata.mat   % input SST time series
SST = testdata*kulite_transform_ab(1,1)+kulite_transform_ab(1,2);
sst=SST(102401:204800)
%------------------------------------------------------ Computation
...
xlim = [0,0.5];  % plotting range
pad = 1;      % pad the time series with zeroes (recommended)
dj = 0.25;    % this will do 4 sub-octaves per octave
s0 = 40960000*dt;    % this says start at a scale of 6 months
...
hold on
contour(time,log2(period),sig95,[-99,1]);
hold on
