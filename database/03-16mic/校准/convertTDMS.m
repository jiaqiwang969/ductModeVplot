...
%     [filename,pathname]=uigetfile({'*.tdms','All Files (*.tdms)'},'Choose a TDMS File','E:\相关试验数据\0.3M\CMG');
    [filename,pathname]=uigetfile({'*.tdms','All Files (*.tdms)'},'Choose a TDMS File','D:\项目\projects\2014-赵发刚-轴承\20150119-SKF');
